        ...
        child: Center(
          child: ValueListenableBuilder<bool>(
            ...
            builder: (context, isPlugOn, _) {
              final consumption = controller.getCurrentConsumption();
              final voltage = controller.voltage;
              ...
              return Column(
                ...
                children: [
                  ...
                  Text('Споживання: ${consumption.toStringAsFixed(1)} W',
                      style: const TextStyle(fontSize: 22),),
                  const SizedBox(height: 30),
                  ElevatedButton(
                    onPressed: controller.togglePlug,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isPlugOn ? Colors.red : Colors.green,
                      padding: const EdgeInsets.symmetric(horizontal: 32,
                          vertical: 16,),
                    ),
                    child: Text(
                      isPlugOn ? 'Вимкнути розетку' : 'Увімкнути розетку',
